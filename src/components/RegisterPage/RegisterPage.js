...
export class RegisterPage extends Component {
    ...
    handlePasswordError = (e) => {
        ...
        if (e.target.value === "") {
            ...
            this.setState({ passwordErrorText: 'Password should be between 8-12 characters containing only alphanumeric values' })
        }
        else if (this.state.confirmPass !== e.target.value) {
            this.setState({
                passwordErrorText: 'Password and confirm password do not match'
    ...
    handleConfirmPasswordError = (e) => {
        ...
        if (this.state.pass === "" && e.target.value === "") {
            ...
            this.setState({
                confirmPassErrorText: 'Confirm Password and password should be same',
                passwordErrorText: 'Password and Confirm password should be the same'
            })
        }
        else {
            this.setState({
    ...
    handlePhoneNoError = (e) => {
        ...
        if (e.target.value === "") {
            ...
            this.setState({ phoneNoErrorText: '' ,disabled:false})
        }
                ...
                <div className="card container" width="80%">
                    ...
                    <div style={{ marginLeft: "30%", width: "50%" }}>
                        <div className="card-body container">
                            ...
                            <FormControl className="mb-3" error={this.state.genderErrorText ? true : false} onChange={this.handleChangeInput} onBlur={this.handleGenderError}>
                                <FormLabel component="legend">Gender</FormLabel>
                                <RadioGroup aria-label="gender" name="gender1" defaultValue="male" onChange={this.handleChangeInput} onBlur={this.handleGenderError}>
                                    <span>
                                ...
                                <Button color="primary" variant="contained" disabled={this.state.disabled} onClick={this.handleRegister}>Register</Button>
